			...
			$sql = "SELECT * from TBL_paccion WHERE pa_id =".$pa_id;
				...
				if (!mysql_num_rows($result) <=0) {
					...
					$mailto = $this->DB_GETEMAIL($row['pa_asignado']);
						...
						$icshtml ='<BR><a href="'.PA_APPURL.'/PA/login.php"><FONT SIZE="3" COLOR="#00AFF9" FACE="Arial"> WPA </FONT></a> <table><tr><td><FONT SIZE="2" COLOR="#666666" FACE="arial">ID:</FONT></td> <td><FONT SIZE="2" COLOR="#666666" FACE="arial">'.$row['pa_id'].'</FONT></td></tr> </table> <table><tr><td><FONT SIZE="2" COLOR="#666666" FACE="arial">No conformidad:</FONT></td><td>\n<FONT SIZE="2"  COLOR="#666666" FACE="arial">'.$row['pa_noconformidad'].'</FONT></td></tr></table> <table><tr><td>	<FONT SIZE="2" COLOR="#666666" FACE="arial">Causa Raiz:</FONT></td><td>	<FONT SIZE="2"  COLOR="#666666" FACE="arial">'.str_replace("\r\n", "\\n",$row['pa_causaraiz']).'</FONT></td></tr></table> <table><tr><td><FONT SIZE="2" COLOR="#666666" FACE="arial">Descripción:</FONT></td><td><FONT SIZE="2"  COLOR="#666666" FACE="arial">'.str_replace("\r\n", "\\n",$row['pa_descsol']).'\n<p> Para consultar el detalle de la solución haz click <a href="'.PA_APPURL.'/PA/viewpa.php?id='.$row['pa_id'].'"> aqui </a></p> </FONT></td></tr></table></FONT> <FONT SIZE="1" FACE="ARIAL">&nbsp;<BR>&nbsp;<BR></FONT> &nbsp; <BR><FONT SIZE="2" COLOR="#666666" FACE="arial"><strong>Creado: </strong>&nbsp;'.$row['pa_creado'].'</FONT>&nbsp; <BR><FONT SIZE="2" COLOR="#666666" FACE="arial"><strong>Cumplimiento</strong>&nbsp;'.$row['pa_fechacumplimiento'].'</FONT>&nbsp; <BR><FONT SIZE="2" COLOR="#666666" FACE="arial">'.$row['pa_responsables'].'</FONT>&nbsp; <BR><a href="'.PA_APPURL.'/PA"><FONT SIZE="1" COLOR="#00AFF9" FACE="arial">Plan de Accion</FONT></a><FONT SIZE="1" FACE="ARIAL">&nbsp;&nbsp;|&nbsp;&nbsp;</FONT><a href="'.PA_APPURL.'/PA/viewpa.php?id='.$row['pa_id'].'"><FONT SIZE="1" COLOR="#00AFF9" FACE="arial">Ver el Plan de Acción</FONT></a> &nbsp; <BR></FONT><BR>	&nbsp;<BR>	<FONT SIZE="1" COLOR="#666666" FACE="arial">¿Requieres soporte?</FONT>	<a href="'.PA_APPURL.'/soporte"><FONT SIZE="1" COLOR="#00AFF9" FACE="Arial">Levanta tu Ticket</a></FONT>&nbsp;<BR>&nbsp;<BR><FONT COLOR="#A0A0A0" size="1" FACE="arial">AVISO IMPORTANTE:</FONT><br />';
		...
		public function RSS_DO() { //Genera el RSS formato XML
			...
			if(!mysql_num_rows($result)<=0) {
				while ($row = mysql_fetch_assoc($result)){
					...
					$rssOutPut.="<link>".PA_APPURL."/PA/viewpa.php?id=".$row['pa_id']."</link>\n";
